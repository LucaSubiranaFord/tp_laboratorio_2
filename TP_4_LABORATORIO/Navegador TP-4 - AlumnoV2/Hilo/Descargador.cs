...
namespace Hilo
{
    ...
    {
        public event ProgressChanged porcentajeEvent;
        public event ProgressComplete completeEvent;
        private string html;
        ...
        public void IniciarDescarga()
        {
            try
            {
                ...
                cliente.DownloadStringAsync(this.direccion); // Original sin parametros
            }
            catch (Exception e)
            {
                throw e;
        ...
        {
            this.porcentajeEvent(e.ProgressPercentage);
        }
        private void WebClientDownloadCompleted(object sender, DownloadStringCompletedEventArgs e)
        {
            if (!e.Cancelled && e.Error == null)
                this.completeEvent(e.Result);
        }
    }
}
